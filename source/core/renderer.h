...
public:
    ...
    void DrawTexture(const Texture& tex, const Point& dest);
    ...
    void DrawPoly(std::initializer_list<Point> ps, const Color& color)
    {
        DrawPoly(ps.begin(), ps.end(), color);
    }

    template <class It>
    void DrawPoly(It b, It e, const Color& color)
    {
